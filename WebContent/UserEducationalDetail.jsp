			   ...
			   <div class="form-group">
				...
				<h3   style="margin-left: 5em; margin-bottom: 1em; color:blue;">Graduation details:-</h3  >
				   ...
				   <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="firstName" placeholder="Specialization" class="form-control" name="specialization" autofocus>
			    ...
			    <div class="form-group">
				 ...
				 <h3   style="margin-left: 5em; margin-bottom: 1em; color:blue;"> Other Education:-</h3  >
				   ...
				   <div class="form-group">
                    <label for="country" class="col-sm-3 control-label">Specialization</label>
                    <div class="col-sm-9">
                     <input type="text" id="firstName" placeholder="Specialization" class="form-control" name="specialization3" autofocus>
